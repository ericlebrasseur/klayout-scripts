...
lines_w = [1, 3, 5, 7, 10] # list of lines width (um)
...
inst = pya.CellInstArray(lines200um_cell.cell_index(), pya.Trans(pya.Point(0, y)), pya.Vector(0, 0), pya.Vector(0, lines_l+10*1e3), 0, inst_n)
...
inst = pya.CellInstArray(lines1000um_cell.cell_index(), pya.Trans(pya.Point(0, y)), pya.Vector(0, 0), pya.Vector(0, lines_l+10*1e3), 0, inst_n)
top_cell.insert(inst)
